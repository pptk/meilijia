...
import com.weiwei.meilijia.calendar.AddCalendar;
...
public class CalendarView extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = LayoutInflater.from(context).inflate(R.layout.jihuai_calendar, null);
		 }
