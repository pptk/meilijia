...
public class QiaomenAdapter extends BaseAdapter{
	private Context context;
	private List<QiaomenModle> list = new ArrayList<QiaomenModle>();
	public AsynctaskImageLoad loader = new AsynctaskImageLoad();
	
	public QiaomenAdapter(Context context, List<QiaomenModle> list) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		QiaomenModle model = list.get(position);
			...
			//将xml布局转换为view对象
			convertView = inflater.inflate(R.layout.qiaomenlist_item,
					null);
			//利用view对象，找到布局中的组件
