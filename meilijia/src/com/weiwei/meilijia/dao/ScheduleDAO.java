...
public class ScheduleDAO {
	private DBOpenHelper dbOpenHelper=null; //创建DBOpenHelper对象
	private SQLiteDatabase db;  //创建SQLiteDatabase对象
	public ScheduleDAO(Context context)  //定义构造函数
	{
		dbOpenHelper=new DBOpenHelper(context);  //初始化DBOpenHelper对象
	}
	/**
	 * 保存日程信息
	 * @param scheduleVO
